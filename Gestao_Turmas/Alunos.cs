...
namespace Gestao_Turmas
{
    ...
    {
        string caminho = @"c:\C\Cprojetos\Gestao_Turmas\alunos.txt";
        ...
        public void bt_adicionar_Click(object sender, EventArgs e)
        {
            ...
            TimeSpan auxdata = (DateTime.Now.Date - dt_nasc.Value.Date);
            DateTime auxdata2 = new DateTime(auxdata.Ticks);
